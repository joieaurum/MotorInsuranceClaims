                ...
                <form class="" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="px-6 py-8 md:p-10">
                        ...
                        <div class="mt-8 flex flex-wrap mb-6">
                            ...
                            <input id="email" type="email" class="appearance-none bg-gray-200 rounded w-full p-3 text-grey-700 focus:shadow-outline{{ $errors->has('email') ? ' border-red-500' : '' }}" name="email" value="{{ old('email') }}" placeholder="johndoe@example.com" required autofocus>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="password" type="password" class="appearance-none bg-gray-200 rounded w-full p-3 text-grey-700 focus:shadow-outline{{ $errors->has('password') ? ' border-red-500' : '' }}" name="password" placeholder="********" required>
                    ...
                    <div class="px-6 md:px-10 py-4 bg-gray-200 border-t border-gray-100 flex flex-wrap items-center">
                        <button type="submit" class="bg-teal-400 w-full hover:bg-pink-300 text-pink-900 font-bold py-3 px-4 rounded focus:outline-none ml-auto">
                            {{ __('Login') }}
                        </button>
                    </div>
                </form>
